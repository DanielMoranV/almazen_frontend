                ...
                <div class="title-section">
                    <div class="title-wrapper">
                        ...
                        <div class="title-text">
                            ...
                            <p v-if="totalProducts > 0" class="subtitle">{{ totalProducts }} {{ totalProducts === 1 ? 'producto' : 'productos' }} con stock total de {{ totalQuantity }} unidades</p>
                            <p v-else class="subtitle">No hay productos con stock disponible</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="actions-section">
                    <div class="action-buttons">
                        ...
                        <Button 
                            ...
                            @click="$emit('print')" 
                            v-tooltip.bottom="'Imprimir reporte'"
                            outlined
                        />
                    </div>
                </div>
