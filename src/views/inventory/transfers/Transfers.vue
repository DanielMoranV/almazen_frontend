...
const filteredTransfers = computed(() => {
    ...
    if (searchQuery.value) {
        ...
        result = result.filter(transfer => 
            ...
            transfer.sourceWarehouse.toLowerCase().includes(query) ||
            transfer.destinationWarehouse.toLowerCase().includes(query) ||
            transfer.createdBy.toLowerCase().includes(query)
        );
    }
