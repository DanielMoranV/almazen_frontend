        ...
        <div class="approval-content">
                ...
                <div class="config-grid">
                    ...
                    <div class="config-item">
                        ...
                        <Select
                            ...
                            class="w-full voucher-select"
                            :class="{ 'p-invalid': errors.voucher_type }"
                        />
            ...
            <div class="payment-methods-section">
                ...
                <div v-else class="payment-methods-list">
                    <div 
                        v-for="(payment, index) in form.payment_methods" 
                        :key="index" 
                        ...
                        <div class="payment-method-content">
                                ...
                                <div class="inputs-grid">
                                    ...
                                    <div v-if="requiresReference(payment.method_id)" class="input-field reference-field">
                                        ...
                                        <InputText
                                            ...
                                            class="w-full reference-input-field"
                                            :class="{ 'p-invalid': getPaymentError(index, 'reference') }"
                                        />
                            ...
                            <div v-if="payment.method_id" class="method-tags-section">
                                <div class="method-tags">
                                    <Tag v-if="getMethodInfo(payment.method_id)?.requires_reference" 
                                         severity="info" 
                                         icon="pi pi-info-circle" 
                                         value="Requiere Referencia" />
                                    <Tag v-if="getMethodInfo(payment.method_id)?.requires_cash_register" 
                                         severity="warning" 
                                         icon="pi pi-desktop" 
                                         value="Requiere Caja" />
                                    <Tag v-if="isCreditsMethod(payment.method_id)" 
                                         severity="help" 
                                         icon="pi pi-credit-card" 
                                         value="Método de Crédito" />
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="summary-content">
                    <div class="summary-grid">
                        ...
                        <div class="summary-item payments-item">
                            ...
                            }">{{ formatCurrency(paymentsTotal) }}</div>
                        </div>
                            ...
                            <div class="item-value" :class="{
                                ...
                                <div class="difference-status">
                                    ...
                                    <span v-else class="status-text success">
                                        <i class="pi pi-check mr-1"></i>Pagos completos
                                    </span>
                                </div>
                            </div>
                        </div>
...
const isFormValid = computed(() => {
    ...
    return form.payment_methods.every((payment, index) => {
        ...
        const validation = paymentMethodsStore.validateMethod(
            payment.method_id,
            payment.amount,
            !!payment.reference
        );
...
watch(() => props.quote?.customer?.id, (newCustomerId) => {
...
.method-badge-cash { @apply bg-green-500; }
.method-badge-card { @apply bg-blue-500; }
.method-badge-transfer { @apply bg-purple-500; }
.method-badge-credit { @apply bg-orange-500; }
.method-badge-default { @apply bg-gray-500; }
