        ...
        <div class="space-y-6">
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="lg:col-span-2">
                    ...
                    <div class="relative">
                        <InputText v-model="internalSearchQuery"
                ...
                <div>
                    ...
                    <Select :modelValue="selectedWarehouse" @update:modelValue="$emit('update:selectedWarehouse', $event)" :options="warehousesList" option-label="name"
            ...
            <div v-if="searchQuery"
                ...
                <div class="flex items-center justify-between">
                    ...
                    <Button @click="clearSearch" icon="pi pi-times"
