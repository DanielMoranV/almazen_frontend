...
<template>
    <Dialog :visible="props.showBatchDialog" @update:visible="$emit('update:showBatchDialog', $event)" header="Seleccionar Lote" :modal="true"
        ...
        <div v-if="props.selectedProductForBatch" class="space-y-4 mt-2">
            ...
            <div class="grid grid-cols-1 gap-4">
                <Card v-for="batch in props.selectedProductForBatch.stock_info?.batches" :key="batch.batch_id"
            ...
            <div class="flex justify-end pt-4 border-t border-gray-200">
                <Button @click="$emit('update:showBatchDialog', false)" label="Cancelar"
