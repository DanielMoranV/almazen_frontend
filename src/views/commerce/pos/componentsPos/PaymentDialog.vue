...
const emit = defineEmits([
    'update:showMultiplePaymentDialog',
...
<template>
    <Dialog :visible="showMultiplePaymentDialog" @update:visible="$emit('update:showMultiplePaymentDialog', $event)" header="Métodos de Pago" :modal="true"
        ...
        <div class="space-y-6 mt-2">
            ...
            <div class="space-y-4">
                ...
                <div class="space-y-3" v-if="props.selectedPaymentMethods.length > 0">
                    <Card v-for="(payment, index) in props.selectedPaymentMethods" :key="index"
                            ...
                            <div class="space-y-4">
                                <div class="flex justify-between items-start">
                                    ...
                                    <Button @click="removePaymentMethod(index)" icon="pi pi-trash" size="small"
                                        severity="danger" text rounded v-if="props.selectedPaymentMethods.length > 1" />
                                </div>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                    ...
                                    <div>
                                        ...
                                        <Select :modelValue="payment.method_id"
                                            @update:modelValue="updatePaymentMethod(index, 'method_id', $event)"
                                            :options="props.availablePaymentMethods" option-label="name" option-value="id"
                                    ...
                                    <div>
                                        ...
                                        <div class="p-inputgroup">
                                            ...
                                            <InputNumber :modelValue="payment.amount"
                                                @update:modelValue="updatePaymentMethod(index, 'amount', $event)" :min="0"
                                                :max="props.cartTotal" mode="decimal" :minFractionDigits="2"
                                    ...
                                    <div>
                                        ...
                                        <InputText :modelValue="payment.reference"
                    ...
                    <div class="grid grid-cols-3 gap-4 text-center">
                        ...
                        <div>
                            ...
                            <div class="text-lg font-bold"
                                :class="getTotalPaymentAmount() === props.cartTotal ? 'text-green-600' : 'text-orange-600'">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <Select :modelValue="props.voucherType" @update:modelValue="$emit('update:voucherType', $event)" :options="props.availableVoucherTypes" option-label="label"
                ...
                <div>
                    ...
                    <div class="flex gap-3">
                        <Button @click="$emit('update:paymentStatus', 'PAGADO')" :label="'Pagado'" :icon="'pi pi-check'"
                            :outlined="props.paymentStatus !== 'PAGADO'"
                            :severity="props.paymentStatus === 'PAGADO' ? 'success' : 'secondary'"
                            class="flex-1 h-12 font-semibold" />
                        <Button @click="$emit('update:paymentStatus', 'PENDIENTE')" :label="'Pendiente'" :icon="'pi pi-clock'"
            ...
            <div class="flex space-x-4 pt-6 border-t border-gray-200">
                <Button @click="$emit('update:showMultiplePaymentDialog', false)" label="Cancelar" icon="pi pi-times"
                    severity="secondary" outlined class="flex-1 h-14 text-lg font-semibold" />
                <Button @click="$emit('process-payment')" label="Confirmar Pago" icon="pi pi-check" severity="success"
                    class="flex-1 h-14 text-lg font-bold" :loading="props.loading"
