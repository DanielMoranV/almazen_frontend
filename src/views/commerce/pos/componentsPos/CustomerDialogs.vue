...
const emit = defineEmits([
    'update:showCustomerDialog',
    'update:showCreateCustomerDialog',
...
const internalNewCustomer = ref(props.newCustomer || {
    name: '',
    email: '',
    phone: '',
    identity_document: '',
...
watch(internalNewCustomer, (newValue) => {
...
<template>
    ...
    <Dialog :visible="props.showCustomerDialog" @update:visible="$emit('update:showCustomerDialog', $event)"
        header="Seleccionar Cliente" :modal="true" :style="{ width: '95vw', maxWidth: '600px' }" :pt="{
        ...
        <div class="space-y-6 mt-2">
            ...
            <div>
                ...
                <AutoComplete v-model="internalCustomerSearch" :suggestions="props.customerResults"
                    @complete="$emit('search-customers', $event.query)" option-label="name"
                    placeholder="Escriba el nombre o documento del cliente..." :loading="props.isSearchingCustomers"
            ...
            <div class="border-t border-gray-200 pt-6">
                <div class="flex justify-between items-center">
                    <Button
                        @click="$emit('update:showCreateCustomerDialog', true); $emit('update:showCustomerDialog', false)"
                        label="Crear Nuevo Cliente" icon="pi pi-plus" severity="success" outlined
                        class="font-semibold" />

                    <Button @click="$emit('update:showCustomerDialog', false)" label="Cancelar" icon="pi pi-times"
    ...
    <Dialog :visible="props.showCreateCustomerDialog" @update:visible="$emit('update:showCreateCustomerDialog', $event)"
        header="Crear Nuevo Cliente" :modal="true" :style="{ width: '95vw', maxWidth: '500px' }" :pt="{
        ...
        <div class="space-y-4 mt-2">
            ...
            <div>
                ...
                <InputText v-model="internalNewCustomer.name" placeholder="Nombre completo del cliente"
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                    ...
                    <Select v-model="internalNewCustomer.identity_document_type" :options="[
                        { label: 'DNI', value: 'dni' },
                        { label: 'RUC', value: 'ruc' },
                ...
                <div class="md:col-span-2">
                    ...
                    <InputText v-model="internalNewCustomer.identity_document" placeholder="Número de documento"
                        class="w-full py-3 px-4 border-2 border-gray-200 focus:border-green-500 rounded-xl" />
                </div>
            </div>
            ...
            <div>
                ...
                <InputText v-model="internalNewCustomer.email" type="email" placeholder="email@ejemplo.com"
                    class="w-full py-3 px-4 border-2 border-gray-200 focus:border-green-500 rounded-xl" />
            </div>
            ...
            <div>
                ...
                <InputText v-model="internalNewCustomer.phone" placeholder="987654321"
                    class="w-full py-3 px-4 border-2 border-gray-200 focus:border-green-500 rounded-xl" />
            </div>
            ...
            <div class="flex space-x-3 pt-4 border-t border-gray-200">
                <Button
                    @click="$emit('update:showCreateCustomerDialog', false); $emit('update:showCustomerDialog', true)"
                    label="Cancelar" icon="pi pi-times" severity="secondary" outlined class="flex-1" />
                <Button @click="$emit('create-quick-customer')" label="Crear Cliente" icon="pi pi-check"
                    severity="success" class="flex-1 font-semibold" :loading="props.loading" />
            </div>
        </div>
    </Dialog>
</template>
