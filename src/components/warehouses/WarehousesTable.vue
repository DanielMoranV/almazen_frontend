    ...
    >
        <template #header>
            <div class="flex flex-wrap gap-2 items-center justify-between mb-3">
                <!-- Exportar Excel -->
                <Button type="button" icon="pi pi-file-excel" label="Exportar" outlined @click="exportWarehouses()" />
        ...
        <Column field="address" header="Dirección" sortable style="min-width: 12rem" />
